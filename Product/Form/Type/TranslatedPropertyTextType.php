...
class TranslatedPropertyTextType extends AbstractType
{
...
//            $builder->add($locale, 'text', array_merge(array('required' => false), $options['field_options'], array('translate_field' => true)));
            $builder->add($locale, 'textarea', array_merge(array('required' => false), $options['field_options']));
        }
...
//        $builder->add('end', 'date', array_merge(array('required' => false), $options['field_options']));
    ...
    {
        return 'ecommerce_type_translated_property_text';
    }
