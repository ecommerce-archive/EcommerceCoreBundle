...
namespace Ecommerce\Bundle\CoreBundle\Util;
 ...
 */
class ControllerUtils extends ContainerAware
{
    /**
    ...
    {
        return $this->container->get('ecommerce_core.cart.manager');
    }
    ...
    {
        return $this->container->get('ecommerce_core.product.manager');
    }
}
